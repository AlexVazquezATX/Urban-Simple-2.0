...
const nextConfig: NextConfig = {
  // The MCP server's `playbooks` tool reads docs/playbooks/*.md at runtime;
  // make sure those files are traced into the serverless bundle for that route.
  outputFileTracingIncludes: {
    '/api/mcp': ['./docs/playbooks/**/*'],
  },
