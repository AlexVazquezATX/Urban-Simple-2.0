  ...
  return (
    <div className="bg-white rounded-sm border border-warm-200 p-5">
      ...
      <textarea
        ...
        rows={4}
        disabled={disabled}
        className="w-full px-3.5 py-3 rounded-sm border border-warm-200 bg-white text-warm-900 placeholder:text-warm-400 focus:outline-none focus:ring-2 focus:ring-lime-500/30 focus:border-lime-500 resize-none text-sm disabled:opacity-50"
      />
